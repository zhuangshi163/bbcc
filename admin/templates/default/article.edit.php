  ...
  <form id="article_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td colspan="2"><label for="article_title">简介</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['article_array']['article_info'];?>" name="article_info" id="article_info" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
