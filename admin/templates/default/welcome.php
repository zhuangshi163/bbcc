  ...
  <div class="info-panel">
    ...
    <dl class="system">
      <dt>
        ...
        <div id="system-info">
          <ul>
            <li>网店交流z3 <?php echo $lang['dashboard_welcome_version'];?><span>20150315</span></li>
      ...
      <dd>
        <ul>
          <li class="w50pre none"><a href="http://bbs.52jscn.com" target="_blank">官方网站<sub></sub></a></li>
          <li class="w50pre none"><a href="http://bbs.52jscn.com" target="_blank">官方论坛<sub></sub></a></li>
        </ul>
      </dd>
    </dl>
    <div class="clear"></div>
