...
final class Base{
	...
	private static function parse_conf(&$setting_config){
		...
		$setting['shopnc_version'] = 'Copyright 2015 <a href="http://bbcc.meec.hk" target="_blank">bbcc.meec.hk</a> All rights reserved<!--.<br />来源于<a href="http://bbcc.meec.hk" target="_blank">bbcc.meec.hk</a>-->';
	...
	private static function cp(){
		...
		if (strpos(self::CPURL,'||') !== false){
			...
			header('location: http://bbs.52jscn.com');exit();
		}else{
