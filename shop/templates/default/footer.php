...
<center><div style=line-height:21px>备案号：<a href="http://www.miitbeian.gov.cn" target=_blank><font> 粤ICP备14059048号-1</font></a>
</div></center>  <?php echo html_entity_decode($output['setting_config']['statistics_code'],ENT_QUOTES); ?> </div>
<?php if (C('debug') == 1){?>
